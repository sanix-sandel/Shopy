...
class ChatConsumer(AsyncJsonWebsocketConsumer):
    ...
    user_type = await database_sync_to_async(
        self.get_user_type
    )(self.scope["user"], self.order_id)#this function besides checking the
    #user type, stores the name of the last employee the customer has spoken
    #to in order
    ...
    async def receive_json(self, content):
        ...
        if typ == "message":
            ...
            )#method to generate the join/leave messages
